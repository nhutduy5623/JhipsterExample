package com.jhipsterexample.microserviceflux.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import com.jhipsterexample.microserviceflux.IntegrationTest;
...
class MicroserviceKafkaResourceIT {
    ...
    private static String KAFKA_API = "/api/microservice-kafka/{command}";
