...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipsterexample.microserviceflux.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.jhipsterexample.microserviceflux.security.DomainUserDetailsService",
