...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipsterexample.monolithic.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipsterexample.monolithic.security.DomainUserDetailsService", "createSpringSecurityUser");
