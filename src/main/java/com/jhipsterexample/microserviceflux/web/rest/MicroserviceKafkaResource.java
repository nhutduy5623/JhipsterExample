...
import com.jhipsterexample.microserviceflux.broker.KafkaConsumer;
...
public class MicroserviceKafkaResource {
    ...
    public MicroserviceKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
